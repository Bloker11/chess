...
function checkIfValid(target) {
    ...
    switch (piece){
        ...
        case "rook":
            ...
            break;
        case "king":
            if (startId + 1 === targetId || startId - 1 === targetId  || startId + width - 1 === targetId || startId + width + 1  === targetId || startId + width  === targetId || startId - width  === targetId  || startId - width - 1  === targetId  || startId + width - 1  === targetId  ||  startId - width + 1  === targetId ){
                return true
            }
            break;
        case "queen":
            if (
              ...
              (startId + width * 7 === targetId &&
                ...
                !document.querySelector(
                  `[square-id = "${startId + width * 6}"]`.firstChild
                )) ||
              //------------------------------------
              startId - 1 === targetId ||
              (startId - 2 === targetId &&
...
function dragDrop(e) {
    e.stopPropagation()
    const correct = draggedElement.firstChild.classList.contains(playerGo)
